...
from salespilot.api.inventory import router as inventory_router
from salespilot.api.nmbrs import router as nmbrs_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(nmbrs_router, prefix=prefix)
